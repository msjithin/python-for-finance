...
rHandPhoto = PhotoImage(file = 'assets/rHand.png')
pHandPhoto = PhotoImage(file = 'assets/pHand.png')
sHandPhoto = PhotoImage(file = 'assets/sHand.png')

rockPhoto = PhotoImage(file = 'assets/rock.png')
paperPhoto = PhotoImage(file = 'assets/paper.png')
scissorsPhoto = PhotoImage(file = 'assets/scissors.png')

winPhoto = PhotoImage(file = 'assets/win.png')
loosePhoto = PhotoImage(file = 'assets/loose.png')
tiePhoto = PhotoImage(file = 'assets/tie.png')
